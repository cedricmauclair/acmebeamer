...
\begin{frame}[fragile]
  {\subsecname \slide 3 of 3}
  {Bad interaction between text and lists}

  Use \cs{fixvspace} around lists to prevent bad interactions with text
  inside blocks.
  ...
  \begin{exampleblock}{Example}
    \kern-2ex
\begin{semiverbatim}
\\begin\marg{block}\marg{Nice title}\oarg{color=yellow}
  Blah, blah, blah…
  \\fixvspace
  \\begin\marg{itemize}
    \\item one
